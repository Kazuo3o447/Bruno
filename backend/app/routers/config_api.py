...
CONFIG_SCHEMA = {
    ...
    "COMPOSITE_FLOOR_LEARNING": {"min": 0, "max": 50, "type": "int", "label": "Composite Floor Learning"},
    "CONFLUENCE_BONUS_2OF3": {"min": -20, "max": 0, "type": "int", "label": "Confluence Bonus (2 of 3)"},
    "MTF_ALIGN_BONUS": {"min": -20, "max": 0, "type": "int", "label": "MTF Align Bonus"},
    "FUNDING_VETO_THRESHOLD_BPS": {"min": 0, "max": 50, "type": "int", "label": "Funding Veto Threshold (bps)"},
    "FUNDING_PREDICTED_HOLD_MIN": {"min": 0, "max": 1440, "type": "int", "label": "Funding Predicted Hold (Min)"},
    "FUNDING_SUBSCORE_WEIGHT": {"min": 0.0, "max": 0.5, "type": "float", "label": "Funding Subscore Weight"},
    ...
    "DAILY_MAX_LOSS_PCT_LEARNING": {"min": 0.0, "max": 100.0, "type": "float", "label": "Daily Max Loss % (Learning)"},
    "MAX_CONSECUTIVE_LOSSES": {"min": 0, "max": 100, "type": "int", "label": "Max Consecutive Losses"},
    "MAX_CONSECUTIVE_LOSSES_LEARNING": {"min": 0, "max": 100, "type": "int", "label": "Max Consecutive Losses (Learning)"},
