...
if _hf_token:
    ...
    _hf_available = False
    logging.getLogger("sentiment_analyzer").critical("HF_TOKEN nicht in Umgebungsvariablen gesetzt - Sentiment-Score-Einfluss wird auf 0 gesetzt")
...
class SentimentAnalyzer:
    ...
    def __init__(self):
        ...
        # NEU: HuggingFace Verfügbarkeit für RiskAgent
        self.hf_available = _hf_available
